...
"C:\Program Files\7-Zip\7z.exe" a %buildFolder%/%buildName%/%buildName%.zip "fonts" "sfx" "sprites" "texts" "playerFunctions.lua" "maid64.lua" "enemyFunctions.lua" "tween.lua" "commands.txt" "main.lua" 
